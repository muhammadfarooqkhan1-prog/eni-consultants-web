    ...
    <main className="bg-slate-950 text-white min-h-screen py-16 px-5 sm:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="text-[#ff7027] font-bold uppercase tracking-wider text-sm">
            Get In Touch
          </span>
          ...
          <p className="text-slate-400 text-base sm:text-lg leading-relaxed">
            Have questions about immigration, study visas, or optimizing your CV for global job offers? Book a 48-hour consultation or drop us a message below.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-20">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-xl">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-slate-400 text-xs uppercase tracking-wider font-semibold">Email Us</h3>
                    <p className="text-white font-bold text-base mt-1">info@eniconsultants.com</p>
                    <p className="text-white font-bold text-base mt-1">muhammadfarooq@eniconsultants
                        .com</p>
                    <p className="text-slate-500 text-xs">Fast responses within 24 hours</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-slate-400 text-xs uppercase tracking-wider font-semibold">WhatsApp & Call</h3>
                    <p className="text-white font-bold text-base mt-1">+92 (333) 5911126</p>
                    <p className="text-white font-bold text-base mt-1">+92 (300) 5012299</p>
                    <p className="text-slate-500 text-xs">Mon - Sat, 9:00 AM - 6:00 PM</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-slate-400 text-xs uppercase tracking-wider font-semibold">Regional Reach</h3>
                    <p className="text-white font-bold text-base mt-1">GCC & Global Support</p>
                    <p className="text-slate-500 text-xs">Serving KSA, UAE, Qatar, Oman, Pakistan & Worldwide</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-slate-900 via-slate-900 to-slate-950 border border-[#ff7027]/40 rounded-3xl p-8 relative overflow-hidden">
              ...
              <h3 className="text-xl font-bold mb-2 text-white">Fast 48-Hour Consultations</h3>
              <p className="text-slate-400 text-sm leading-relaxed mb-4">
                Schedule a priority evaluation session directly with senior consultant Muhammad Farooq Khan.
              </p>
            ...
            {isSubmitted ? (
              <div className="text-center py-16 space-y-4">
                ...
                <p className="text-slate-400 text-sm max-w-md mx-auto">
                  We have received your message. One of our senior immigration experts will review your details and reach out within 24 hours.
                </p>
                <button
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <h2 className="text-2xl font-bold text-white mb-6">Book a Free Assessment / Query</h2>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-slate-950 border border-slate-800 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#ff7027] text-sm"
                  >
                    <option value="Skilled Immigration (PR)">Skilled Immigration (Canada, Australia, UK)</option>
                    <option value="CV & LinkedIn Optimization">CV, Cover Letter & LinkedIn Optimization</option>
                    <option value="Study Abroad">Study Abroad / Foreign Admission</option>
                    <option value="Visit & Holiday Visa">Visit / Tourist Visa (Schengen, UK, US)</option>
                ...
                <button
                  type="submit"
                  className="w-full bg-[#ff7027] hover:bg-[#e05a14] text-white font-bold py-4 rounded-xl transition-all shadow-lg shadow-orange-500/20 text-base border-0 cursor-pointer"
                >
                  Submit Inquiry Now
                </button>
              </form>
        ...
        <div className="max-w-4xl mx-auto border-t border-slate-800 pt-16">
          ...
          <div className="space-y-6">
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
              <h3 className="text-white font-bold text-lg mb-2">How long does an eligibility evaluation take?</h3>
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
              <h3 className="text-white font-bold text-lg mb-2">Can ENI Consultants assist GCC residents remotely?</h3>
              <p className="text-slate-400 text-sm leading-relaxed">
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
              <h3 className="text-white font-bold text-lg mb-2">How does the CV & LinkedIn Optimization service work?</h3>
              <p className="text-slate-400 text-sm leading-relaxed">
